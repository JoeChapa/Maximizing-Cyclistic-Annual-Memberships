...
The Cyclistic trip data allows us to identify differences in customer behavior and will help us answer our research question. However, the size of the data is a challenge as it significantly increases memory usage in RStudio. Based on our analysis, we recommend using a machine with at least 16 GB of RAM to efficiently replicate our results. A detailed data dictionary is provided below.
...
write_csv(to_csv , file = paste0(getwd(), "/processed_csv/customer_data_cleaned.csv"))
```
